...
## Roadmap
1. Game stoppage in the middle of pegging. This will more than likely occur the need of passing the cumulative totals of bot the computer and the user into the pegging() function as new imputs and returning an output in case a break occurs and a "player" wins off of pegging. I forsee much troubleshooting occuring with this in the future
...
3. Taking out sequences from the first_card() decision making in the computer since runs do not count during hand play in this game. 
